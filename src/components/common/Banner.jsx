  ...
  return (
    <BannerWrapper className='d-flex align-items-center justify-content-start' style = {{
      ...
      <div className='banner-content w-100 container text-white'>
        <div className='banner-badge text-uppercase'>Entre na Live</div>
        <h1 className='banner-title text-uppercase'>Melhor jogo da semana</h1>
        <p className='lead-text'>GTA V - Grand Theft Auto V e um jogo eletrônico de ação-aventura desenvolvido pela Rockstar North e publicado pela Rockstar Games.</p>
        <button type="button" className='banner-btn d-flex align-items-center'>
          <span className='btn-icon'>
            <FaGamepad className='text-white' size = { 25 } />
          </span>
          <span className='btn-text text-green'>Jogue agora</span>
        </button>
      </div>
    </BannerWrapper>
  )
