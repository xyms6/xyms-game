        ...
        <div className='block-wrap'>
          <div className='details-group'>
            <div className='details-item d-flex align-items-center'>
              <p className='details-item-name fw-6'>Data de Lançamento:&nbsp;</p>
              <p className='details-item-value'>{ gameData?.released}</p>
            </div>
            <div className='details-item d-flex align-items-center'>
              <p className='details-item-name fw-6'>Atualização:&nbsp;</p>
              <p className='details-item-value'>{ gameData?.updated}</p>
            </div>
          </div>
          <Link to = {`/games/${gameData?.id}`} className='card-button text-uppercase mt-3'>Ver mais</Link>
        </div>
      </div>
    </GenreItemWrapper>
  )
