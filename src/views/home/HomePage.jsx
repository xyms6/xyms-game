        ...
        <div className="container w-100">
          <div className="join-content text-white mx-auto text-center">
            <h2 className="join-title mb-3">
              ENTRE NA <span>COMUNIDADE</span>
            </h2>
            <p className="lead-text">
            Junte-se à nossa comunidade Discord que está em construção e é feita por
            jogadores para jogadores. Todos são bem-vindos para participar, não importa o jogo que você
            brincar, estamos&apos;aqui para nos divertir.
            </p>
